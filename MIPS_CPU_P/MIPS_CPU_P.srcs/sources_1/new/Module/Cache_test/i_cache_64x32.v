...
module i_cache_64x32 (                          // instr cache
    input clk,
    input clrn,
    ...
    assign c_write = cache_miss & ~uncached & m_ready;  // 这里用uncache来避免I/O数据进入Cache
    assign c_din = m_dout;
